...
let
      ...
      recAttrByPath =
        ...
        if builtins.length addresses == 0 then
          ...
          let
            ...
            addressesRemaining = lib.lists.drop 1 addresses;
          in
          lib.attrByPath addressNext (recAttrByPath addressesRemaining default attrs) attrs;
    in
    packageJsonAttrs:
  ...
  yarnHash = "sha256-TSL/zus3w3cRYUYuYFByRRlIS0dkJrxCoxTr/qt8oVk=";
  ...
  prettier-oxc-wasm-parser = stdenv.mkDerivation (finalAttrs: {
    ...
    src = fetchurl {
      ...
      sha256 = "sha256-W4YZAbFjLJpRbDv1U24ydFuGuC+FlDcV8UsoJQ6+kL4=";
    };
    ...
    pnpmDeps = fetchPnpmDeps {
      ...
      pnpm = pnpm_10;
      fetcherVersion = 3;
      hash = "sha256-Wtgh69SaLR7pM374Dtr8w3srDO4WpOoS72jXyd36ZuI=";
    };
...
stdenv.mkDerivation (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-8b37j9efxhYO9du+88JCvTrWit+Ws/HJmHNIEHz3sSE=";
  };
